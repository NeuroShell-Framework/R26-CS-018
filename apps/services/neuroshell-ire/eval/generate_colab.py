"""Generate the self-contained Colab notebook for Exp3."""
import os

OUT = os.path.join(os.path.dirname(__file__), "colab_exp3.py")

# Read category_metrics.py to embed it
CM_PATH = os.path.join(os.path.dirname(__file__), "category_metrics.py")
with open(CM_PATH, "r", encoding="utf-8") as f:
    cm_code = f.read()

parts = []

# ── Part 1: Header + Ollama setup ──
...
# ── Part 3: System prompt + constants ──
parts.append(r'''
...
# ── Part 5: LLM Inference + Full Pipeline ──
parts.append(r'''
# %% [markdown]
...
# ── Part 6: Metrics + Ablation Runner ──
parts.append(r'''
# %% [markdown]
